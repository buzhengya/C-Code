#line 1 "d:\\c++code\\robot\\gtest\\sample2.cpp"
#line 1 "d:\\c++code\\robot\\gtest\\sample2.h"
#pragma once
...
#line 12 "c:\\program files (x86)\\windows kits\\10\\include\\10.0.10240.0\\ucrt\\string.h"
...
#line 3 "d:\\c++code\\robot\\gtest\\sample2.h"
...
public:
	...
	MyString() : c_string_(0) {}

	
	explicit MyString(const char* a_c_string) : c_string_(0) {
		Set(a_c_string);
	}

	
	MyString(const MyString& string) : c_string_(0) {
	...
	size_t Length() const {
		return c_string_ == 0 ? 0 : strlen(c_string_);
	}

	
	void Set(const char* c_string);
};
#line 2 "d:\\c++code\\robot\\gtest\\sample2.cpp"




const char* MyString::CloneCString(const char* a_c_string) {
	if (a_c_string == 0) return 0;
